...
export const $FetchRecommendedLecuturesSchema = {
    properties: {
        data: {
            items: {
                '$ref': '#/components/schemas/LectureInFetch'
            },
            type: 'array',
            title: 'Data'
        },
...
export const $LectureForArtistView = {
    properties: {
        id: {
            type: 'integer',
            title: 'Id'
    ...
    title: 'LectureForArtistView'
} as const;

export const $LectureInFetch = {
    properties: {
        id: {
            type: 'integer',
            title: 'Id'
...
export const $UserArtistInfo = {
    properties: {
        ...
        lectures: {
            items: {
                '$ref': '#/components/schemas/LectureForArtistView'
            },
            type: 'array',
            title: 'Lectures'
        }
